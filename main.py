...
def main():
    ...
    bot = telegram.bot.Bot(token='6221002451:AAElJjzMQw9aPVUpaLj9oReFdK7Ht3Mvtkk')
    ...
    updater.start_webhook(
        listen='0.0.0.0',
        port=443,
        url_path='6221002451:AAElJjzMQw9aPVUpaLj9oReFdK7Ht3Mvtkk',
        key='/etc/letsencrypt/live/malipo.online/privkey.pem',
        cert='/etc/letsencrypt/live/malipo.online/fullchain.pem',
        webhook_url='https://api.telegram.org/bot6221002451:AAElJjzMQw9aPVUpaLj9oReFdK7Ht3Mvtkk/setWebhook?url=https://malipo.online'
    )
